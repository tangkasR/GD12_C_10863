package com.example.gd12_pdf_c_10863
...
import com.example.gd12_pdf_c_10863.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        val file = File(pdfPath, "pdf_10863.pdf")
        ...
        val d = getDrawable(R.drawable.shank)
